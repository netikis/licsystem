(function(){
    ...
    function activate(view){
      ...
      var map={dashboard:'Dashboard',captacao:'Captação de Editais',analiseIa:'Análise Inteligente de Editais',leiloesParticipo:'Leilão que Participo',orcamento:'Orçamento',cruzamento:'Cruzamento Inteligente (ML)',cofre:'Cofre de Documentos',docsChecklist:'Documentos do Edital',entregas:'Licitação',histEntregas:'Histórico e Controle de Entregas',concorrencia:'Análise de Concorrência',catalogo:'Catálogo Interno',arp:'Atas de Registro (ARP)',disputa:'Sala de Disputa',ferramentas:'Ferramentas'};
