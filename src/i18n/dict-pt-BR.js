...
(function (LICSYSTEM) {
  ...
  bag.dict["pt-BR"] = {
      ...
      "pwa.title": "Instalar o aplicativo",
      "pwa.desc": "Instale o LICSYSTEM no Android, no iPhone ou no computador. O ícone LS fica na tela inicial e na área de trabalho.",
      "pwa.install": "Instalar app",
      "pwa.android": "Instalar no Android",
      "pwa.iphone": "Instalar no iPhone",
      "pwa.desktop": "Instalar no computador",
      "pwa.installed": "O aplicativo já está instalado neste aparelho.",
      "pwa.iconHint": "Ícone do aplicativo",
      "common.save": "Salvar",
