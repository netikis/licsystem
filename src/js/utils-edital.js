...
(function (LICSYSTEM) {
  ...
  var EDITAL_UNDS =
    "UNID\\.?|UND\\.?|UNI|UN|Unid\\.?|UNIDADE|CAIXA|QUILO|METROS|METRO|ROLOS|ROLO|PACOTES?|PE[CÇ]AS|PE[CÇ]A|PCS|BARRA|LT|L|BL|BAL|GAL|KG|MT|M³|M²|M3|M2|M|PC|PÇ|CX|PAR|CJ|KIT|PCT|POTE|RL|BD|SC|GL|JOGO|PAR|SV|HR|VB|DZ";
