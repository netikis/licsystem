...
(function () {
  ...
  var PHRASES = {
    "en": {
      ...
      "Espelho do edital: à esquerda os dados importados; à direita seus preços. <b>Meu total</b> = Qtd do edital × Valor de Venda. A <b>%</b> de lucro calcula sozinha ao preencher o Valor de Venda (pode digitar a % manualmente para ignorar o automático).": "Notice mirror: imported data on the left; your prices on the right. <b>My total</b> = Notice qty × Sale price. Profit <b>%</b> is calculated when you fill Sale Price (type % manually to override).",
      ...
      "Registre empenho, nota fiscal, anexos e destinação logística. Dados locais por enquanto — prontos para Firebase Storage / Firestore.": "Register commitment, invoice, attachments and logistics destination. Local data for now — ready for Firebase Storage / Firestore.",
      ...
      "↺ Exemplos": "↺ Examples",
      "+ Novo item": "+ New item",
      "Baixa manual de quantidade entregue, saldo pendente e lucro em tempo real. Persistência local — preparado para Firestore.": "Manual write-off of delivered quantity, pending balance and real-time profit. Local persistence — ready for Firestore.",
    ...
    "es": {
      ...
      "Espelho do edital: à esquerda os dados importados; à direita seus preços. <b>Meu total</b> = Qtd do edital × Valor de Venda. A <b>%</b> de lucro calcula sozinha ao preencher o Valor de Venda (pode digitar a % manualmente para ignorar o automático).": "Espejo del edicto: a la izquierda los datos importados; a la derecha sus precios. <b>Mi total</b> = Cant. del edicto × Valor de Venta. El <b>%</b> de lucro se calcula al completar Valor de Venta (escriba % manualmente para ignorar lo automático).",
      ...
      "Registre empenho, nota fiscal, anexos e destinação logística. Dados locais por enquanto — prontos para Firebase Storage / Firestore.": "Registre compromiso, factura, anexos y destino logístico. Datos locales por ahora — listos para Firebase Storage / Firestore.",
      ...
      "Baixa manual de quantidade entregue, saldo pendente e lucro em tempo real. Persistência local — preparado para Firestore.": "Baja manual de cantidad entregada, saldo pendiente y ganancia en tiempo real. Persistencia local — preparado para Firestore.",
