...
(function () {
  ...
  var PHRASES = {
    "en": {
      ...
      "Espelho do edital: à esquerda os dados importados; à direita seus preços na mesma linha do lote. <b>Meu total</b> = Qtd do edital × meu V. Unitário. A <b>%</b> calcula sozinha em relação ao V. Unitário do edital.": "Notice mirror: imported data on the left; your prices on the right on the same lot row. <b>My total</b> = Notice qty × my unit price. <b>%</b> is calculated automatically vs the notice unit price.",
    ...
    "es": {
      ...
      "Espelho do edital: à esquerda os dados importados; à direita seus preços na mesma linha do lote. <b>Meu total</b> = Qtd do edital × meu V. Unitário. A <b>%</b> calcula sozinha em relação ao V. Unitário do edital.": "Espejo del edicto: a la izquierda los datos importados; a la derecha sus precios en la misma fila del lote. <b>Mi total</b> = Cant. del edicto × mi V. Unitario. El <b>%</b> se calcula solo frente al V. Unitario del edicto.",
